...
//     const referralLink = `https://solarx0.com/signup?ref=${
//       teamData?.user?.randomCode || "REF174085491"
//     }`;
...
//   const referralLink = `https://solarx0.com/signup?ref=${referralCode}`;
...
const InviteScreen = () => {
  ...
  const shareLink = async () => {
    const referralLink = `https://metadrive01.xyz/signup?ref=${
      teamData?.user?.randomCode || "REF174085491"
    }`;
  ...
  // Fallback data if teamData is still null
  const referralCode = teamData?.user?.randomCode || "REF174085491";
  const referralLink = `https://metadrive01.xyz/signup?ref=${referralCode}`;
