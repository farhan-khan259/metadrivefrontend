...
export default function UserCommission() {
  ...
  const commissionLevels = {
    directReferrals: { label: "Level 1", rate: 0.065 },
    indirectReferrals: { label: "Level 2", rate: 0.033 },
    extendedReferrals: { label: "Level 3", rate: 0.025 },
    level4Referrals: { label: "Level 4", rate: 0.02 },
    level5Referrals: { label: "Level 5", rate: 0.015 },
  };
